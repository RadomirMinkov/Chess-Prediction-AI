...
clf_xgb = xgb.XGBClassifier(objective='multi:softmax', num_class=3,early_stopping_rounds=10 , n_estimators =200,  eval_metric='mlogloss', missing=None, random_state=7)
